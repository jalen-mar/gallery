...
public class DateUtils {
     ...
     * @return
     */
    public static String getCreateFileName(String prefix, Context context) {
        String suffix;
        try {
            suffix = context.getApplicationContext().getPackageName();
            suffix = "_" + suffix.substring(suffix.lastIndexOf('.') + 1);
        } catch (Exception e) {
            suffix = "_jalen_gallery";
        }
        long millis = System.currentTimeMillis();
        return prefix + sf.format(millis) + suffix;
    }
