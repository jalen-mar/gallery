...
import com.gemini.jalen.gallery.lib.broadcast.BroadcastAction;
import com.gemini.jalen.gallery.lib.broadcast.BroadcastManager;
...
import com.gemini.jalen.gallery.lib.listener.ImageCompleteCallback;
import com.gemini.jalen.gallery.lib.permissions.PermissionChecker;
import com.gemini.jalen.gallery.lib.photoview.PhotoView;
...
import com.gemini.jalen.gallery.lib.widget.PreviewViewPager;
import com.gemini.jalen.gallery.lib.widget.longimage.ImageSource;
import com.gemini.jalen.gallery.lib.widget.longimage.ImageViewState;
import com.gemini.jalen.gallery.lib.widget.longimage.SubsamplingScaleImageView;
...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    private void savePictureAlbum() throws Exception {
        ...
        String fileName = DateUtils.getCreateFileName("IMG_", getApplication()) + suffix;
    ...
    private void savePictureAlbumAndroidQ(Uri inputUri) {
        ...
        contentValues.put(MediaStore.Images.Media.DISPLAY_NAME, DateUtils.getCreateFileName("IMG_", getApplication()));
