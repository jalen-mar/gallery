...
import com.gemini.jalen.gallery.lib.compress.Luban;
import com.gemini.jalen.gallery.lib.compress.OnCompressListener;
...
import com.gemini.jalen.gallery.lib.dialog.PictureLoadingDialog;
import com.gemini.jalen.gallery.lib.entity.LocalMedia;
import com.gemini.jalen.gallery.lib.entity.LocalMediaFolder;
import com.gemini.jalen.gallery.lib.immersive.ImmersiveManage;
import com.gemini.jalen.gallery.lib.immersive.NavBarUtils;
...
import com.gemini.jalen.gallery.lib.tools.VoiceUtils;
...
public abstract class PictureBaseActivity extends AppCompatActivity implements Handler.Callback {
    ...
    protected void startCrop(String originalPath, String mimeType) {
        ...
        File file = new File(PictureFileUtils.getDiskCacheDir(this),
                TextUtils.isEmpty(config.renameCropFileName) ? DateUtils.getCreateFileName("IMG_", getApplication()) + suffix : config.renameCropFileName);
    ...
    protected void startCrop(ArrayList<CutInfo> list) {
        ...
        String suffix = mimeType.replace("image/", ".");
        File file = new File(PictureFileUtils.getDiskCacheDir(this),
                TextUtils.isEmpty(config.renameCropFileName) ? DateUtils.getCreateFileName("IMG_", getApplication())
