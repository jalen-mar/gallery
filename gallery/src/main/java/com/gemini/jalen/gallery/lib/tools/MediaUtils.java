...
public class MediaUtils {
    ...
    public static Uri createImageUri(final Context context) {
        ...
        values.put(MediaStore.Images.Media.DISPLAY_NAME, DateUtils.getCreateFileName("IMG_", context));
    ...
    public static Uri createVideoUri(final Context context) {
        ...
        // ContentValues是我们希望这条记录被创建时包含的数据信息
        ContentValues values = new ContentValues(3);
        values.put(MediaStore.Video.Media.DISPLAY_NAME, DateUtils.getCreateFileName("VID_", context));
