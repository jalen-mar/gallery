package com.gemini.jalen.gallery.lib.camera;
...
import com.gemini.jalen.gallery.lib.PictureMediaScannerConnection;
import com.gemini.jalen.gallery.lib.R;
import com.gemini.jalen.gallery.lib.camera.listener.CameraListener;
import com.gemini.jalen.gallery.lib.camera.listener.CaptureListener;
import com.gemini.jalen.gallery.lib.camera.listener.ClickListener;
import com.gemini.jalen.gallery.lib.camera.listener.ImageCallbackListener;
import com.gemini.jalen.gallery.lib.camera.listener.TypeListener;
import com.gemini.jalen.gallery.lib.camera.view.CaptureLayout;
import com.gemini.jalen.gallery.lib.config.PictureMimeType;
import com.gemini.jalen.gallery.lib.config.PictureSelectionConfig;
import com.gemini.jalen.gallery.lib.tools.AndroidQTransformUtils;
import com.gemini.jalen.gallery.lib.tools.DateUtils;
import com.gemini.jalen.gallery.lib.tools.MediaUtils;
import com.gemini.jalen.gallery.lib.tools.PictureFileUtils;
import com.gemini.jalen.gallery.lib.tools.SdkVersionUtils;
import com.gemini.jalen.gallery.lib.tools.StringUtils;
...
public class CustomCameraView extends RelativeLayout {
    ...
    public void initView(Context context) {
        ...
        mCaptureLayout.setCaptureListener(new CaptureListener() {
            ...
            public void takePictures() {
                ...
                mCameraView.takePicture(createImageFile(context), ContextCompat.getMainExecutor(getContext()),
            ...
            public void recordStart() {
                ...
                mCameraView.startRecording(createVideoFile(context), ContextCompat.getMainExecutor(getContext()),
    ...
    public File createImageFile(Context context) {
        if (SdkVersionUtils.checkedAndroid_Q()) {
            ...
            String newFileImageName = isOutFileNameEmpty ? DateUtils.getCreateFileName("IMG_", context) + suffix : mConfig.cameraFileName;
    ...
    public File createVideoFile(Context context) {
        if (SdkVersionUtils.checkedAndroid_Q()) {
            ...
            String newFileImageName = isOutFileNameEmpty ? DateUtils.getCreateFileName("VID_", context) + suffix : mConfig.cameraFileName;
            File cameraFile = new File(rootDir, newFileImageName);
